      ...
      <div className="flex w-full max-w-5xl flex-wrap items-center justify-between gap-4 py-2">
        ...
        <nav className="flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          <Popover className="relative">
            ...
            <PopoverPanel
              transition
              className="absolute left-1/2 -translate-x-1/2 top-full z-50 mt-3 w-screen origin-top rounded-xl border border-mist bg-white shadow-xl transition data-[closed]:-translate-y-1 data-[closed]:opacity-0 data-[enter]:duration-200 data-[enter]:ease-out data-[leave]:duration-150 data-[leave]:ease-in"
            >
              <div className="p-4">
