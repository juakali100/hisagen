...
import { TagBadge, YieldComparison, MetricsGrid, SourceFileLink } from "../../../../components/knowledge-base";
import {
        ...
        {sortedEvidence.map((entry) => (
          ...
          >
            ...
            {entry.sourceFiles && entry.sourceFiles.length > 0 && (
              <div className="mb-4 p-3 rounded-lg bg-amber-50/60 border border-amber-200/40">
                ...
                <div className="space-y-1.5">
                  {entry.sourceFiles.map((sf, idx) => (
                    <SourceFileLink key={idx} {...sf} />
                  ))}
                </div>
              </div>
            )}
