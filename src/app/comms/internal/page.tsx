    ...
    <main className="min-h-screen bg-parchment">
      <div className="bg-secondary text-white py-12 px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-sm uppercase tracking-wider opacity-80 mb-2">Comms Function 08</p>
          <h1 className="text-4xl font-serif font-bold">Internal Communications</h1>
          <p className="mt-4 text-lg opacity-90">
            Team updates, partner communications, and documentation
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        <div className="bg-white rounded-lg p-8 shadow-sm border border-mist text-center">
          ...
          <p className="text-slate mb-6">
            This page will organize team updates, partner communications,
            meeting templates, and onboarding materials.
          </p>
