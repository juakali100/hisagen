    ...
    <div className="mx-auto max-w-5xl text-ink font-sans">
      ...
      <section className="mb-12">
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute top-12 left-0 right-0 h-1 bg-gradient-to-r from-primary via-sky-teal to-accent rounded-full" style={{ marginLeft: '4%', marginRight: '4%', width: '92%' }} />

          <div className="grid gap-4 md:grid-cols-7">
            {[
              { step: "1", title: "Farmer Enrolment", desc: "Smallholders join via Deep Six partnership", icon: "/icons/icon-farmer.png", color: "primary" },
              { step: "2", title: "Baseline", desc: "Initial soil carbon measurement", icon: "/icons/icon-graph.png", color: "primary" },
              { step: "3", title: "Practice Adoption", desc: "Locus AG bio-stimulants + regen practices", icon: "/icons/icon-seedling.png", color: "primary" },
              { step: "4", title: "Monitoring", desc: "3Degrees MRV platform tracks progress", icon: "/icons/icon-circular-arrows.png", color: "sky-teal" },
              { step: "5", title: "Verification", desc: "Third-party audit against VM0042", icon: "/icons/icon-leaf-check.png", color: "sky-teal" },
              { step: "6", title: "Issuance", desc: "Verra registry issues credits", icon: "/icons/icon-certificate.png", color: "accent" },
              { step: "7", title: "Sale & Distribution", desc: "Corporate buyer purchase, target 70%+ to farmers (TBC)", icon: "/icons/icon-hand-money.png", color: "accent" },
            ].map((item) => (
              <div key={item.step} className="relative flex flex-col items-center text-center">
                {/* Step circle with icon */}
                <div className={`relative z-10 w-20 h-20 rounded-full flex items-center justify-center mb-3 ${
                  item.color === "primary" ? "bg-primary/10 border-2 border-primary" :
                  item.color === "sky-teal" ? "bg-sky-teal/10 border-2 border-sky-teal" :
