    ...
    <div className="mx-auto max-w-5xl text-ink">
      ...
      <section className="mt-12">
        <div className="flex items-center gap-4 mb-6">
          <h2 className="text-xl font-bold text-secondary uppercase tracking-[0.15em]">Partner Profiles</h2>
          <div className="h-px flex-1 bg-mist" />
        </div>
        <p className="text-sm text-slate mb-6">Click each partner to view detailed profile information, key personnel, and strategic context.</p>
