...
export const communications: CommunicationEntry[] = [
    ...
    attachments: [
      {
        ...
        format: 'PDF',
        portalLink: '/knowledge-base/research',
      },
    ],
  ...
  },
  {
    ...
    attachments: [
      { title: 'Uganda Maize Trials Results (Summary)', file: 'DSC-004-uganda-maize-trials-results1.pdf', format: 'PDF', portalLink: '/knowledge-base/evidence/uganda-pilot' },
      { title: 'Uganda Maize Phase 2 Data Collection', file: 'DSC-006-uganda-maize-phase2-data.pdf', format: 'PDF', portalLink: '/knowledge-base/evidence/uganda-pilot' },
      { title: 'Uganda Maize Trials Results 1 (Raw)', file: 'DSC-005-uganda-maize-trials-results1.xlsx', format: 'Excel', portalLink: '/knowledge-base/evidence/uganda-pilot' },
    ],
    synthesis: [
