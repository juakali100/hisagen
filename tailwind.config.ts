...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary Brand Colors (HISAGEN official)
        primary: "#1F4D3A", // Deep Regenerative Green - main brand color
        secondary: "#2D2A26", // Black Cotton Soil - institutional feel
        accent: "#C6A04A", // Harvest Gold - highlight/CTA color

        // Neutral Colors
        ink: "#0F172A", // Nearly black for body text
        slate: "#334155", // Dark grey for secondary text
        mist: "#CBD5E1", // Light grey for backgrounds
        parchment: "#F7F8F5", // Parchment - warm off-white base background (HISAGEN official)
